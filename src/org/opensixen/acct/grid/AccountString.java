...
public class AccountString extends CTextField implements KeyListener, VEditor{
	...
	public void propertyChange(PropertyChangeEvent arg0) {
		...
		if(getDisplay()!=null && getDisplay().length()>0){
			AcctEditorSearch.setParameter(getDisplay());
		}
	}
